...
A major challenge in improving road safety is the limited understanding of accident patterns and contributing factors. Accident records often contain large amounts of information, but without proper cleaning, analysis, and visualization, it is difficult to identify meaningful trends such as high-risk locations, common causes, affected road users, vehicle involvement patterns, and periods when accidents are more frequent.

This project aims to address this challenge by applying Python-based data analysis techniques to a Kenyan road accident dataset. Through data cleaning, exploratory analysis, and visualization, the project seeks to uncover patterns and generate insights that can improve understanding of road accident trends in Kenya.

The analysis will focus on identifying accident hotspots, examining major accident causes, understanding the characteristics of affected victims, and analyzing the relationship between accidents, locations, time, and vehicle categories. The findings can support evidence-based decision-making and contribute to improved road safety planning and awareness.
